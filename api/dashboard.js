...
import { authCode, withApi } from './lib/auth.js';
import { buildDashboard } from './lib/dashboard-core.js';
...
//
// All computation lives in lib/dashboard-core.js so the entire pipeline -- snapshot/batch
